...
class DeliveryNoteController extends AbstractBaseController implements PushInterface
{
    ...
    /**
     * @return WC_Advanced_Shipment_Tracking_Actions|AST_Pro_Actions|null
     */
    protected function getShipmentTrackingActions(): WC_Advanced_Shipment_Tracking_Actions|AST_Pro_Actions|null
    {
