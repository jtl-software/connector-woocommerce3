...
class ManufacturerController extends AbstractBaseController implements PushInterface, PullInterface, DeleteInterface, StatisticInterface
{
    ...
    public function pull(QueryFilter $queryFilter): array
    {
        ...
        if (SupportedPlugins::isPerfectWooCommerceBrandsActive()) {
            $sql = SqlHelper::manufacturerPull($queryFilter->getLimit());
    ...
    public function push(AbstractModel $model) : AbstractModel
    {
        if (SupportedPlugins::isPerfectWooCommerceBrandsActive()) {
            ...
            $name = wc_sanitize_taxonomy_name(substr(trim($model->getName()), 0, 27));
