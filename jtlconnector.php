 ...
 * Version: 1.6.0-dev
 * WC tested up to: 3.5.1sssssssssssssssssss
 ...
 */
define( 'TEXT_DOMAIN', 'jtlconnector' );
define( 'WOOCOMMERCE_PLUGIN_FILE', 'woocommerce/woocommerce.php' );
...
try {
	if ( file_exists( CONNECTOR_DIR . '/connector.phar' ) ) {
		if ( is_writable( sys_get_temp_dir() ) ) {
			$loader = require( 'phar://' . CONNECTOR_DIR . '/connector.phar/vendor/autoload.php' );
			$loader->add( '', CONNECTOR_DIR . '/plugins' );
		}
	} else {
		$loader = require( CONNECTOR_DIR . '/vendor/autoload.php' );
		$loader->add( '', CONNECTOR_DIR . '/plugins' );
	}
} catch ( \Exception $e ) {
